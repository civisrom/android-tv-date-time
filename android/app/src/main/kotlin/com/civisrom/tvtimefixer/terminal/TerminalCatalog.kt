...
val terminalCatalog: List<CommandCategory> = listOf(
    ...
    CommandCategory("time", R.string.terminal_category_time, listOf(
        ...
        CommandExample("time_8", R.string.terminal_example_time_8, "date -u '+%Y-%m-%dT%H:%M:%SZ'"),
        CommandExample("time_9", R.string.terminal_example_time_9, "date +%s"),
        CommandExample("time_10", R.string.terminal_example_time_10, "dumpsys time_detector"),
        CommandExample("time_11", R.string.terminal_example_time_11, "dumpsys time_zone_detector"),
        CommandExample("time_12", R.string.terminal_example_time_12, "dumpsys network_time_update_service"),
        CommandExample("time_13", R.string.terminal_example_time_13, "cmd time_detector help"),
        CommandExample("time_14", R.string.terminal_example_time_14, "cmd time_zone_detector help"),
    )),
    CommandCategory("apps", R.string.terminal_category_apps, listOf(
        ...
        CommandExample("apps_11", R.string.terminal_example_apps_11, "pm list packages -s"),
        CommandExample("apps_12", R.string.terminal_example_apps_12, "pm list packages -d"),
        CommandExample("apps_13", R.string.terminal_example_apps_13, "pm list packages -U -i"),
        CommandExample("apps_14", R.string.terminal_example_apps_14, "dumpsys package PACKAGE"),
        CommandExample("apps_15", R.string.terminal_example_apps_15, "pm list features"),
        CommandExample("apps_16", R.string.terminal_example_apps_16, "am get-current-user"),
    )),
    CommandCategory("files", R.string.terminal_category_files, listOf(
        ...
        CommandExample("files_8", R.string.terminal_example_files_8, "stat /sdcard/Download/file.txt"),
        CommandExample("files_9", R.string.terminal_example_files_9, "sha256sum /sdcard/Download/file.txt"),
        CommandExample("files_10", R.string.terminal_example_files_10, "find /sdcard/Download -maxdepth 1 -type f"),
    )),
    CommandCategory("system", R.string.terminal_category_system, listOf(
        ...
        CommandExample("system_9", R.string.terminal_example_system_9, "getprop ro.product.cpu.abilist"),
        CommandExample("system_10", R.string.terminal_example_system_10, "getprop ro.build.version.security_patch"),
        CommandExample("system_11", R.string.terminal_example_system_11, "getenforce"),
    )),
    CommandCategory("network", R.string.terminal_category_network, listOf(
        ...
        CommandExample("network_5", R.string.terminal_example_network_5, "ip -s link"),
        CommandExample("network_6", R.string.terminal_example_network_6, "ip neigh show"),
        CommandExample("network_7", R.string.terminal_example_network_7, "ip -6 addr show"),
        CommandExample("network_8", R.string.terminal_example_network_8, "ip -6 route show"),
        CommandExample("network_9", R.string.terminal_example_network_9, "settings get global private_dns_mode"),
        CommandExample("network_10", R.string.terminal_example_network_10, "settings get global private_dns_specifier"),
    )),
    CommandCategory("input", R.string.terminal_category_input, listOf(
        ...
        CommandExample("input_6", R.string.terminal_example_input_6, "dumpsys input"),
        CommandExample("input_7", R.string.terminal_example_input_7, "dumpsys display"),
    )),
    CommandCategory("logs", R.string.terminal_category_logs, listOf(
        ...
        CommandExample("logs_7", R.string.terminal_example_logs_7, "dumpsys meminfo PACKAGE"),
        CommandExample("logs_8", R.string.terminal_example_logs_8, "dumpsys gfxinfo PACKAGE"),
        CommandExample("logs_9", R.string.terminal_example_logs_9, "dumpsys cpuinfo"),
    )),
