...
enum class Operation {
    ...
    USB_DETACHED, USB_SCAN, READ_DEVICE, CHECK_NTP, APPLY_NTP, SCAN_NTP, DISCOVERY, CRASH, STORAGE, CHECK_TIME, APPLY_TIME_ZONE, TERMINAL,
    CHECK_CONNECTION, TIME_SETTINGS,
}
...
enum class DiagnosticIssue {
    ...
    NTP_PERMISSION_DENIED, CONNECTION_LOST,
}
